    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Rzut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // generowanie losowych wartości dla kostek
                ...
                for (int i = 1; i <= 6; i++) { // przechodzenie przez liczby od 1 do6
                    int count = 0;
                    for (int value : values) { // przechodzimi przez kazdy element talbicy, a value to obecna wartosc
                        if (value == i) {
                            count++;
                        }
                    }
                    if (count > 1) {
                        Wynik = Wynik + i * count; // jesli w naszej tablicy powtarza sie jakas liczba to dodajemy ja i mnoziymy przez to ile razy sie powtarza
                    }
                }
